/**
 * Comprehensive test suite for better-starlite
 * Tests both SQLite and RQLite with all operations
 * Run with: node test/comprehensive-test.js
 */
...
async function testAggregatesAndFunctions(db, dbType) {
...
async function testEdgeCases(db, dbType) {
...
async function runAllTests() {
  console.log('🧪 Starting comprehensive test suite for better-starlite\n');
