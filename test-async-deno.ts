/**
 * Test the async interface in Deno
 * Run with: deno run --allow-read --allow-write --allow-net test-async-deno.ts
 */

import { createDatabase, AsyncDatabase } from './src/async-unified-deno.ts';

async function testSqlite() {
  console.log('Testing SQLite with async interface in Deno...');
...
console.log('\nAll Deno async tests completed!');